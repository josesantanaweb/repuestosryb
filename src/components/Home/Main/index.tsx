...
const Category = ({ category }: CategoryProps) => {
  return (
    ...
    >
      ...
      <p className="text-base text-white uppercase">{category.name}</p>
    </div>
  )
}
  ...
  return (
    <main className="main">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        <img src="/images/logo.svg" alt="logo" className="w-[26rem] mb-20" />
        <h1 className="text-[2.5rem] text-secondary uppercase text-center font-bold font-kanit italic mb-5 drop-shadow-[0_4px_4px_rgba(203,0,13,0.20)]">
