  ...
  return (
    <main className="border-b-4 main border-secondary">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center max-w-[60rem] mx-auto]">
        <h1 className="text-[4.25rem] text-secondary text-center font-bold font-kanit opacity-15">QUIÉNES SOMOS</h1>
        <h1 className="text-[1.5rem] text-secondary text-center font-light font-kanit mb-2">BIENVENIDO A</h1>
